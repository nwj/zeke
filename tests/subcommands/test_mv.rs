...
#[test]
fn does_not_modify_other_aspects_of_moved_note() -> Result<()> {
    let t = ZekeTester::new();
    t.setup_fs("subcommands/test_mv/does_not_modify_other_aspects_of_moved_note/")?;
...
fn does_not_modify_other_aspects_of_linked_notes() -> Result<()> {
    let t = ZekeTester::new();
    t.setup_fs("subcommands/test_mv/does_not_modify_other_aspects_of_linked_notes/")?;
